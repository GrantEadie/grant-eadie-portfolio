...
function Contact() {
  ...
  function sendEmail(e) {
    ...
    emailjs.sendForm('service_sm55lsb', 'template_tt9qgul', e.target, 'user_w8sHIJyUnS3FlWLFhzzOu')
      .then((result) => {
    ...
    return (
      ...
      >
        ...
        <a
          href="https://www.linkedin.com/in/grant-eadie/"
        >
          <svg
          style={{ marginRight: "15px"}}
          className="socials"
        ...
        <a className="emailContact" href="mailto:grantleadie@gmail.com">
